...
module.exports = class Utils {
  ...
  /**
   * Removes the object properties recursively
   * @param {Object|Array<Object>} object Content to be analyzed and modified
   * @param {string[]} properties Name of the object keys to be removed
   * @private
   */
  static removeProperties (object, properties) {
    if (object instanceof Array) {
      object.forEach((_object) => Utils.removeProperties(_object, properties))
    } else if (!!object && object.constructor === Object) {
      Object.getOwnPropertyNames(object).forEach((key) => {
        if (properties.includes(key)) {
          delete object[key]
        } else {
          Utils.removeProperties(object[key], properties)
        }
      })
    }
